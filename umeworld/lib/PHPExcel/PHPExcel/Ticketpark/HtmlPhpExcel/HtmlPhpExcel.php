...
namespace umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel;

use umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel\Elements\Document;
use umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel\Elements\Cell;
use umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel\Elements\Row;
use umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel\Exception\HtmlPhpExcelException;
use umeworld\lib\PHPExcel\PHPExcel\Ticketpark\HtmlPhpExcel\Parser\Parser;
...
class HtmlPhpExcel
{
	...
	public function setHtmlStringOrFile($htmlStringOrFile)
	{
		$this->htmlStringOrFile = $htmlStringOrFile;
	}

	public function setExcelObject($oPhpexcel)
	{
